...
// +----------------------------------------------------------------------+
//
// $Id: ITX.php,v 1.6 2001/07/27 12:47:17 mansion Exp $
//
...
* @access   public
* @version  $Id: ITX.php,v 1.6 2001/07/27 12:47:17 mansion Exp $
* @package  IT[X]
*/
class IntegratedTemplateExtension extends IntegratedTemplate {
    ...
    */    
    function updateBlockvariablelist($block) {
        ...
        while (list($k,$varname) = each($regs[1])) {
            $this->blockvariables[$block][$varname] = true;
        }
